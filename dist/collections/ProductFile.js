...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductIds, orders, purchasedProductFileIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductIds = products.map(function (prod) { return prod.product_files; }).flat();
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                            depth: 2,
                            where: {
                ...
                case 2:
                    ...
                    purchasedProductFileIds = orders
                        ...
                        return order.products.map(function (product) {
                            if (typeof product === "string")
                                return req.payload.logger.error("Search depth not sufficient to find purchase file IDs");
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductIds, true), purchasedProductFileIds, true),
                            },
                        }];
            }
        });
