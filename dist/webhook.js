...
var resend = new resend_1.Resend((_a = process.env.RESEND_API_KEY) !== null && _a !== void 0 ? _a : "re_JmP2sqDx_Mygi66E1c66CwvYyMRttFZLT");
        ...
        switch (_c.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        from: "HippoHarbour <hello@joshtriedcoding.com>",
                        to: [user.email],
