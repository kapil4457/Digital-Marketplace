                ...
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: "22px" } },
                            ...
                            React.createElement(components_1.Link, { href: "".concat((_b = process.env.NEXT_PUBLIC_SERVER_URL) !== null && _b !== void 0 ? _b : "http://localhost:3000", "/thank-you?orderId=").concat(orderId), style: productLink }, "Download Asset")),
