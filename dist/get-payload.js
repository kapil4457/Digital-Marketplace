...
var cache = global.payload;
if (!cache) {
    cache = global.payload = {
        client: null,
        promise: null,
    };
}
var PAYLOAD_SECRET = "my_secret";
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (cache.client) {
                        return [2 /*return*/, cache.client];
                    }
                    if (!cache.promise) {
                        cache.promise = payload_1.default.init(__assign({ secret: PAYLOAD_SECRET, email: {
                ...
                case 3:
                    ...
                    cache.promise = null;
                    throw err_1;
                case 4: return [2 /*return*/, cache.client];
            }
        });
    });
};
